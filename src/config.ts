...
export const DIALOGUES: readonly DialogueDefinition[] = [
  {
    ...
    "lines": [
      ...
      {
        "id": "ch0335_memoriallobby_1_2",
        "text": {
          "zh-cn": "",
          "ja": "私が消えることはありません。",
          "ko": "전 사라지지 않아요.",
          "en": "I won't disappear."
        }
      }
    ]
  },
  {
    ...
    "lines": [
      {
        "id": "ch0335_memoriallobby_2_1",
        "text": {
          "zh-cn": "",
          "ja": "むしろ、その逆ですね。",
          "ko": "오히려 그 반대죠.",
          "en": "It'll be the opposite, in fact."
        }
      },
      {
        "id": "ch0335_memoriallobby_2_2",
        "text": {
          "zh-cn": "",
          "ja": "私は、どんな手を使ってでも\n生き残ってやるつもりですから。",
          "ko": "무슨 수를 써서라도 아득바득\n살아남아 줄 생각이니까요.",
          "en": "I will struggle to survive no matter what it takes."
        }
      }
    ]
  },
  {
    ...
    "lines": [
      {
        "id": "ch0335_memoriallobby_3_1",
        "text": {
          "zh-cn": "",
          "ja": "先生がこの世界を\n見捨てないというのなら。",
          "ko": "선생님이 이 세계를\n포기하지 않는다면.",
          "en": "If Sensei does not\ngive up on this world..."
        }
      },
      {
        "id": "ch0335_memoriallobby_3_2",
        "text": {
          "zh-cn": "",
          "ja": "私だって最後まで、\n絶対に諦めたりしません。",
          "ko": "저 역시,\n언제까지나 포기하지\n않을 생각이고요.",
          "en": "I too, will never give up."
        }
      }
    ]
  },
  {
    ...
    "lines": [
      {
        "id": "ch0335_memoriallobby_4_1",
        "text": {
          "zh-cn": "",
          "ja": "だから大丈夫……\n絶対、大丈夫です。",
          "ko": "그러니까…… 괜찮아요.\n전부 괜찮아요.",
          "en": "So... It's okay. Everything is okay."
        }
      },
      {
        "id": "ch0335_memoriallobby_4_2",
        "text": {
          "zh-cn": "",
          "ja": "私はずっとここにいます。",
          "ko": "저는, 쭉 여기에 있을 거예요.",
          "en": "I'll continue to be here."
        }
      }
    ]
  },
  {
    ...
    "lines": [
      {
        "id": "ch0335_memoriallobby_5_1",
        "text": {
          "zh-cn": "",
          "ja": "ここだけの話ですけど……\n私は――",
          "ko": "여기에서만 하는 말이지만……\n저는……",
          "en": "I'm just saying this here... But I..."
        }
      },
      {
        "id": "ch0335_memoriallobby_5_2",
        "text": {
          "zh-cn": "",
          "ja": "先生のこと、\n嫌いじゃありませんから。",
          "ko": "선생님을,\n그렇게 싫어하지\n않으니까요.",
          "en": "...don't hate you that much."
        }
      }
    ]
  }
